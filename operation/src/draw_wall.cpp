...
bool server(operation::edit_wall_set::Request &req, operation::edit_wall_set::Response &res  ){
    ...
    ss>>map_id_path;
    ss.str("");
    path="/var/www/maps/"+map_id_path+"/"+map_id_path+".jpeg";
    ...
    for(int i=0;i<wall_num;i++){
        ...
        ss>>wall_id_path;
        ss.str("");
        path="/var/www/nav_manager/"+map_id+path+"/wall_pose"+wall_id_path+".json";
        is.open(path.c_str());
        ...
        path="/var/www/maps/"+map_id_path+"/"+map_id_path+"_edit.jpg";

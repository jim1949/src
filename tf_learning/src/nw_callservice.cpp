...
{  
  ...
  srv.request.nav_pose.worldposition.position.x=5;
  srv.request.nav_pose.worldposition.position.y=0;
  srv.request.nav_pose.worldposition.position.z=0;
  srv.request.nav_pose.worldposition.orientation.x=0;
  srv.request.nav_pose.worldposition.orientation.y=0;
  srv.request.nav_pose.worldposition.orientation.z=0;
  srv.request.nav_pose.worldposition.orientation.w=1;
